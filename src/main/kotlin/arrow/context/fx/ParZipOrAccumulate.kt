...
public suspend inline fun <E, A, B, C> parZipOrAccumulate(
    ...
    crossinline fa: suspend context(CoroutineScope, Raise<E>, Raise<NonEmptyList<E>>)
    () -> A,
    crossinline fb: suspend context(CoroutineScope, Raise<E>, Raise<NonEmptyList<E>>)
    () -> B,
...
public suspend inline fun <E, A, B, C, D> parZipOrAccumulate(
    ...
    crossinline fb: suspend context(CoroutineScope, Raise<E>, Raise<NonEmptyList<E>>)
    () -> B,
    crossinline fc: suspend context(CoroutineScope, Raise<E>, Raise<NonEmptyList<E>>)
    () -> C,
...
public suspend inline fun <E, A, B, C, D, F> parZipOrAccumulate(
    ...
    crossinline fc: suspend context(CoroutineScope, Raise<E>, Raise<NonEmptyList<E>>)
    () -> C,
    crossinline fd: suspend context(CoroutineScope, Raise<E>, Raise<NonEmptyList<E>>)
    () -> D,
...
public suspend inline fun <E, A, B, C, D, F, G> parZipOrAccumulate(
    ...
    crossinline fd: suspend context(CoroutineScope, Raise<E>, Raise<NonEmptyList<E>>)
    () -> D,
    crossinline ff: suspend context(CoroutineScope, Raise<E>, Raise<NonEmptyList<E>>)
    () -> F,
...
public suspend inline fun <E, A, B, C, D, F, G, H> parZipOrAccumulate(
    ...
    crossinline ff: suspend context(CoroutineScope, Raise<E>, Raise<NonEmptyList<E>>)
    () -> F,
    crossinline fg: suspend context(CoroutineScope, Raise<E>, Raise<NonEmptyList<E>>)
    () -> G,
...
public suspend inline fun <E, A, B, C, D, F, G, H, I> parZipOrAccumulate(
    ...
    crossinline fg: suspend context(CoroutineScope, Raise<E>, Raise<NonEmptyList<E>>)
    () -> G,
    crossinline fh: suspend context(CoroutineScope, Raise<E>, Raise<NonEmptyList<E>>)
    () -> H,
...
public suspend inline fun <E, A, B, C, D, F, G, H, I, J> parZipOrAccumulate(
    ...
    crossinline fh: suspend context(CoroutineScope, Raise<E>, Raise<NonEmptyList<E>>)
    () -> H,
    crossinline fi: suspend context(CoroutineScope, Raise<E>, Raise<NonEmptyList<E>>)
    () -> I,
...
public suspend inline fun <E, A, B, C, D, F, G, H, I, J, K> parZipOrAccumulate(
    ...
    crossinline fi: suspend context(CoroutineScope, Raise<E>, Raise<NonEmptyList<E>>)
    () -> I,
    crossinline fj: suspend context(CoroutineScope, Raise<E>, Raise<NonEmptyList<E>>)
    () -> J,
